...
Original file is located at
    https://colab.research.google.com/drive/1slCT0dclj1ZD0iUjwIMeLnC0YLqOcqXt
"""
...
interpreter = tf.lite.Interpreter(model_path='/content/drive/MyDrive/virta/model/lite-model_movenet_singlepose_lightning_3.tflite')
interpreter.allocate_tensors()
#membacagambar
imgdata=cv2.imread('/content/drive/MyDrive/virta/foto 2/Hp nesy/Denis.jpg')
image=cv2.cvtColor(imgdata, cv2.COLOR_BGR2RGB)
width = image.shape[1]
...
#membacagambar
imgdata=cv2.imread('/content/drive/MyDrive/virta/foto 2/Hp nesy/Noven.jpg')
image=cv2.cvtColor(imgdata, cv2.COLOR_BGR2RGB)
width = image.shape[1]
height = image.shape[0]
print(width)
